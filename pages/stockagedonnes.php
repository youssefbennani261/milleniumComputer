...
<head>
	...
	<title> Milinium Computer - Périphériques externes stockage de données </title>
	<!-- favicon -->
...
<body>
	...
	<!-- Hero Area Start  -->
	<header class="breadcrumb extra-padding">
			...
			<div class="row">
				<div class="col-12 text-center">
						...
						<ul class="links">
							...
							<li>
								<a class="active" href="stockagedonnes.php">
								Périphériques externes stockage de données
								</a>
							</li>
						</ul>
				</div>
